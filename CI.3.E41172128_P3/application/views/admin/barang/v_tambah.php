  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="<?php base_url('index.php/barang/add');?>"method="POST" entype"multipart/form-data">
        ...
        <input type="number" name = "harga" id="harga" class="form-control" placeholder="harga" required="required"> 
